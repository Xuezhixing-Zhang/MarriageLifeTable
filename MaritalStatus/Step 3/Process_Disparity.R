...
write.csv(NeverMarried, file = "./Disparity_NM.csv",
          row.names = F)
write.csv(Married, file = "./Disparity_M.csv",
          row.names = F)
write.csv(Divorced, file = "./Disparity_D.csv",
          row.names = F)
write.csv(Widowed, file = "./Disparity_W.csv",
          row.names = F)
