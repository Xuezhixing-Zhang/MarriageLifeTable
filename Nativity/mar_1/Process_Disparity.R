...
v1 <- grid.arrange(arrangeGrob(NM+labs(title = "Never Married")+
                                 # xlim(0,35)+
...
# 
write.csv(NeverMarried, file = "./disparity_nat/Disparity_Never_Married.csv",
          row.names = F)
write.csv(Married, file = "./disparity_nat/Disparity_Married.csv",
          row.names = F)
write.csv(Divorced, file = "./disparity_nat/Disparity_Divorced.csv",
          row.names = F)
write.csv(Widowed, file = "./disparity_nat/Disparity_Widowed.csv",
          row.names = F)
